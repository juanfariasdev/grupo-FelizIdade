    ...
    <footer className="w-full border-t bg-card">
      <div className="container mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 py-8 sm:flex-row md:px-6">
        ...
        <p className="text-base text-gray-500 text-center">
          ...
          <br/>
          Site produzido por <a href="https://juanpablofarias.com" className="underline" target="_blank" rel="noopener noreferrer">Alunos do de Bacharel em Sistemas de Informação</a> - IF Sul de Minas Campus Machado
        </p>
